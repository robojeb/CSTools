...
private:
  DeclCheckVisitor Visitor;
};

void checkDecls(string filename, vector<Issue>& lineIssues){
...
DeclCheckVisitor::DeclCheckVisitor(vector<Issue>& lineIssues,
...
bool DeclCheckVisitor::VisitDecl(Decl *d)
{
...
void DeclCheckVisitor::checkField(clang::Decl* d)
{
...
void DeclCheckVisitor::checkVariable(clang::Decl* d)
{
  auto loc = getDeclLocation(d);
...
void DeclCheckVisitor::checkFunction(clang::Decl* d)
{
  auto loc = getDeclLocation(d);
...
void DeclCheckVisitor::checkClass(clang::Decl* d)
{
  auto loc = getDeclLocation(d);
...
pair<int, int> DeclCheckVisitor::getDeclLocation(clang::Decl* d)
{
